      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 md:p-8 shadow-sm">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3 bg-slate-50 dark:bg-slate-700/40 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700">
            ...
            {pendingOffers.length === 0 ? (
              ...
              pendingOffers.map(offer => {
                ...
                return (
                  <div
                    key={offer.id}
                    className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 md:p-8 shadow-sm hover:border-turkcell-blue dark:hover:border-turkcell-yellow/40 transition-all space-y-6"
                  >
                    {/* Top line */}
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      {/* Score & Discount */}
                      <div className="flex items-center space-x-4 bg-slate-50 dark:bg-slate-700/40 p-3 rounded-2xl border border-slate-200/70 dark:border-slate-700">
                    ...
                    {/* XAI Reasoning Box */}
                    <div className="p-4 bg-slate-50 dark:bg-slate-700/50 border border-slate-200/80 dark:border-slate-700 rounded-2xl flex items-start space-x-3">
          ...
          <div className="space-y-4">
            {acceptedOffers.length === 0 ? (
              ...
              acceptedOffers.map(offer => (
                <div key={offer.id} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 shadow-sm space-y-4">
                  ...
                  {/* Rating box */}
                  <div className="p-4 bg-slate-50 dark:bg-slate-700/40 rounded-2xl border border-slate-200/80 dark:border-slate-700 flex items-center justify-between">
                    <div>
